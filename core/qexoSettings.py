...
ALL_SETTINGS = [  # [名称, 默认值, 是否在尝试修复时重置, 简介]
    ...
    ["INIT", "2", False, "初始化标识"],
    ["QEXO_ICON", "https://s3.bmp.ovh/imgs/2022/11/23/129c19d56d22c637.png", False, "站点ICON"],
    ["QEXO_LOGO", "https://s3.bmp.ovh/imgs/2022/11/23/129c19d56d22c637.png", False, "站点LOGO"],
