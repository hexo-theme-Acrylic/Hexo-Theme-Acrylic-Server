...
ALL_SETTINGS = [  # [名称, 默认值, 是否在尝试修复时重置, 简介]
    ...
    ["INIT", "2", False, "初始化标识"],
    ["QEXO_ICON", "https://avatars.githubusercontent.com/u/124778279?s=200&v=4", False, "站点ICON"],
    ["QEXO_LOGO", "https://avatars.githubusercontent.com/u/124778279?s=200&v=4", False, "站点LOGO"],
